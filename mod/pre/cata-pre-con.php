...
<tr>
    <td><label><input type="radio" name="rdOrden" value="eCodPresentacion" checked="checked"> C&oacute;digo</label></td>
    <td>
        <input type="text" class="form-control" name="eCodPresentacion" id="eCodPresentacion">
    </td>
    <td><label><input type="radio" name="rdOrden" value="tNombre" checked="checked"> Nombre</label></td>
    <td>
