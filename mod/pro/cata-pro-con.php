...
<tr>
    <td><label><input type="radio" name="rdOrden" value="eCodProducto" checked="checked"> C&oacute;digo</label></td>
    <td>
        <input type="text" class="form-control" name="eCodProducto" id="eCodProducto">
    </td>
