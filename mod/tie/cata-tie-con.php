...
<tr>
    <td><label><input type="radio" name="rdOrden" value="eCodTienda" checked="checked"> C&oacute;digo</label></td>
    <td>
        <input type="text" class="form-control" name="eCodTienda" id="eCodTienda">
    </td>
    <td><label><input type="radio" name="rdOrden" value="tNombre" checked="checked"> Nombre(s)</label></td>
    <td>
